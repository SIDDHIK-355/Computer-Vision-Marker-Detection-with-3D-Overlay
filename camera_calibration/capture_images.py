import cv2 as cv
import os # used to create a folder for saving photos

Chess_Board_Dimensions = (9, 6)
# 9 from left -> right
# 6 from top -> bottom

n = 0  #This keeps track of how many pictures you have saved.
...
# find the chessboard corners accurately but if it takes too long, stop after 30 tries
